...
<body>
    ...
    <header class="hero">
        <div class="hero-content">
            ...
            <p>Modify vehicle specifications as needed</p>
        </div>
    </header>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" action="vup">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="brand_model" placeholder="Brand & Model" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="chassis_no" placeholder="Chassis Number" required>
                            </div>
                            <div class="mb-3">
